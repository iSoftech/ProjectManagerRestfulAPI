...
/**
 * Project Manager Restful API Integration Tests for Task Resource Controller
 * 
...
@SpringBootTest (
		...
		classes = {ProjectManagerRestfulApiApp.class, TaskResource.class}
)
...
public class TaskResourceTests {
	...
	public void setUp() {
		...
		// Project
		project = new Project(Long.valueOf(1001));
		// Task
		task = new Task();
