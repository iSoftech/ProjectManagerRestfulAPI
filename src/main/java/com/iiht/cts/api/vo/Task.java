...
public class Task {
	...
	public Task(Long taskId, String taskName, Integer priority, Date startDate, Date endDate, String active,
			ParentTask parentTask, Project project, User user, String isParentTask) {
		this.taskId = taskId;
	...
	public int hashCode() {
		...
		result = prime * result + ((isParentTask == null) ? 0 : isParentTask.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (user == null) {
			...
			return false;
		if (isParentTask == null) {
			if (other.isParentTask != null)
				return false;
		} else if (!isParentTask.equals(other.isParentTask))
			return false;
		return true;
	}
	...
	public String toString() {
		return "Task [taskId=" + taskId + ", taskName=" + taskName + ", priority=" + priority + ", startDate="
				...
				+ ", modifiedDate=" + modifiedDate + ", parentTask=" + parentTask + ", project=" + project 
				+ ", user=" + user + ", isParentTask=" + isParentTask + "]";
	}
}